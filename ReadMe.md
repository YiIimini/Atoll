...
| **[中文优化版](https://github.com/YiIimini/Atoll/releases)** | [v2.2.0-cn DMG](https://github.com/YiIimini/Atoll/releases/tag/v2.2.0-cn) | 基于原版增强，详见下方区别 |
...
| AI 供应商 | 仅 Gemini | **7 家**：Gemini / OpenAI / Claude / Groq / DeepSeek / OpenRouter / 本地 Ollama |
