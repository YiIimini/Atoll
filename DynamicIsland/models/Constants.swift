...
static let enableDeepseekProvider = Key<Bool>("enableDeepseekProvider", default: true)
    ...
    static let enableZhipuProvider = Key<Bool>("enableZhipuProvider", default: true)
    static let enableBaichuanProvider = Key<Bool>("enableBaichuanProvider", default: true)
    static let enableYiProvider = Key<Bool>("enableYiProvider", default: true)
    static let enableMinimaxProvider = Key<Bool>("enableMinimaxProvider", default: true)
    static let enableSparkProvider = Key<Bool>("enableSparkProvider", default: true)
